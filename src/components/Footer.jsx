    ...
    <div className="Footer_main">
        <div className="Footer">
            ...
            <div className="Footer_subscribe">
               ...
               "Подпишитесь сегодня, чтобы получать советы, последние новости и эксклюзивные специальные предложения. - Подпишитесь сегодня, чтобы получать советы, последние новости и эксклюзивные специальные предложения."}
               </p>
